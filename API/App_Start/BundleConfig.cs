...
namespace Upload_File_To_ASPNET_Web_API
{
	public class BundleConfig
	{
		...
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			bundles.Add(new ScriptBundle("~/bundles/formscripts")
				.Include("~/Scripts/jquery.form.js")
				.Include("~/Scripts/knockout-2.2.0.js")
				.Include("~/Scripts/fileuploadbyform.js")
				);

			bundles.Add(new StyleBundle("~/Content/customcss")
				.Include("~/Content/UploadContainer.css")
				.Include("~/Content/FormUploadContainer.css"));
		}
	}
}